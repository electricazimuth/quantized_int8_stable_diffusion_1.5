...
def preprocess_model(input_path: str, output_path: str):
    ...
    shape_inference.quant_pre_process(input_path, output_path, skip_symbolic_shape=False)
...
unet_onnx_model_file = "fixedsize/unet_torch32/model.onnx"
...
# Preprocess (Optional)
# preprocess_model(unet_onnx_model, "unet_preprocessed.onnx") <-- doesnt work due to the lack of onnx version version 
